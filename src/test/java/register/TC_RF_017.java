...
public class TC_RF_017 {
	...
	@Test(dataProvider="passwordSuppliers")
	public void verifyRegisteringAccountEnteringPassowordFollowingComplexcityStandars(String passwordText) {
		...
		String expectedWarningMessage = "Enter password which follows Password Complexity Standard!";
	...
	@DataProvider (name="passwordSuppliers")
	public Object[][] passowordSuppliers() {
