...
public class TC_RF_013 {
	...
	@Test
	public void verifyRegisteringAccountPlaceHolders() {
		...
		String expectedPassowrdPlaceHolder = "Password";
		String expectedPassowordConfirmPlaceHolder ="Password Confirm";
		...
		Assert.assertEquals(driver.findElement(By.id("input-password")).getAttribute("placeholder"), expectedPassowrdPlaceHolder);
		Assert.assertEquals(driver.findElement(By.id("input-confirm")).getAttribute("placeholder"), expectedPassowordConfirmPlaceHolder);
