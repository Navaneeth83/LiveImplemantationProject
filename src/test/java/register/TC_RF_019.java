...
public class TC_RF_019 {
	...
	@Test
	public void verifyRegisteringAccountLeadindgandTrailingSpaces() {
		...
		driver.findElement(By.xpath("//input[@class='btn btn-primary'][@value='Continue']")).click();
		...
		String actualEmailText = driver.findElement(By.id("input-email")).getDomAttribute("value");
		softAssert.assertEquals(actualEmailText,emailText.trim() );
		
		String actualTelephone = driver.findElement(By.id("input-telephone")).getDomAttribute("value");
